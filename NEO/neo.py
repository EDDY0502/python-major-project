...
engine.setProperty('voice', voices[1].id)  # Male voice (use voices[2] for female)

def speak(audio):  #text to speech
    engine.say(audio)
    engine.runAndWait()
    print(audio)  # optional: to see what it's saying
    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            if "open notepad" in query:
                ...
                speak("No input detected. Goodbye sir.")
                sys.exit()
...
class Main(QMainWindow): #----->main UI interface
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("C:/Users/HirenChandwani/Downloads/python-adv-project-main/back.png")
        self.ui.label.setMovie(self.ui.movie)
        self.ui.movie.start()

        self.ui.movie = QtGui.QMovie("C:/Users/HirenChandwani/Downloads/python-adv-project-main/nova.gif")
        self.ui.label_2.setMovie(self.ui.movie)
        self.ui.movie.start()

        self.ui.movie = QtGui.QMovie("C:/Users/HirenChandwani/Downloads/python-adv-project-main/start end.gif")
